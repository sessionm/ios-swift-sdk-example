 ...
 */
@property(nullable, nonatomic, strong, readonly) NSArray<SMReceipt *> *receipts;
 ...
 */
- (NSString *)uploadReceiptImages:(NSArray <NSString *> *)assetIDs withCampaignID:(NSString *)campaignID placementID:(NSString * _Nullable)placementID data:(NSDictionary * _Nullable)data __attribute__((deprecated("Use uploadReceiptImages:withCampaignID:placementID:data:completionHandler:progressHandler:")));
/*!
 @abstract Uploads the receipt images with the specified asset identifiers for the specified campaign.
 @param assetIDs Array of <code>PHObject</code> <code>localIdentifier</code> strings.
 @param campaignID ID of promotional campaign for which receipt is being uploaded.
 ...
 */
- (NSString *)uploadReceiptImageFiles:(NSArray <NSString *> *)paths withCampaignID:(NSString *)campaignID placementID:(NSString * _Nullable)placementID data:(NSDictionary * _Nullable)data __attribute__((deprecated("Use uploadReceiptImageFiles:withCampaignID:placementID:data:completionHandler:progressHandler:")));
/*!
 @abstract Uploads the receipt images with the specified file paths for the specified campaign.
 @param paths Array of image file paths.
 @param campaignID ID of promotional campaign for which receipt is being uploaded.
