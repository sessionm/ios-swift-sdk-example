 ...
 */
typedef void (^didFetchTransactions)(NSArray<SMTransaction *>* _Nullable transactions, BOOL hasMore, SMError * _Nullable error);
 ...
 */
- (BOOL)fetchTransactionsWithStartDate:(NSDate * _Nullable)startDate endDate:(NSDate * _Nullable)endDate limit:(int)limit __attribute__((deprecated("Use fetchTransactionsWithStartDate:endDate:limit:completionHandler:")));
/*!
 @abstract Makes a request to update @link transactions @/link with a limited number of the current user's points transactions that took place between the specified start and end dates.
 @param startDate Transactions after this date will not be fetched (optional).
 @param endDate Transactions before this date will not be fetched (optional).
 ...
 @result <code>BOOL</code> indicating whether the request will be sent.
 */
- (BOOL)fetchTransactionsWithStartDate:(NSDate * _Nullable)startDate endDate:(NSDate * _Nullable)endDate limit:(int)limit completionHandler:(didFetchTransactions)onCompletion;
/*!
