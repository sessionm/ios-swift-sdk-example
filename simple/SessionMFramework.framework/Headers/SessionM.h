 ...
 */
typedef NS_ENUM(NSInteger, SMActivityAutoDismissStyle) {
 ...
 */
- (void)sessionM:(SessionM *)sessionM didUpdateUserRegistrationResult:(SMUserRegistrationResultType)result errorMessages:(NSArray<NSString *> * _Nullable)errorMessages;
- (void)sessionM:(SessionM *)sessionM didUpdateUserRegistrationResult:(SMUserRegistrationResultType)result errors:(NSDictionary<NSString *, NSObject *> * _Nullable)errors;
/*!
 ...
 */
- (UIView * _Nullable)sessionM:(SessionM *)session viewForActivity:(SMActivityType)type;
/*!
 ...
 */
 - (UIViewController * _Nullable)sessionM:(SessionM *)session viewControllerForActivity:(SMActivityType)type;
/*!
 ...
 */
- (void)sessionM:(SessionM *)sessionM user:(SMUser *)user didPerformAction:(SMActivityUserAction)action forActivity:(SMActivity *)activity withData:(NSDictionary<NSString *, NSObject *> * _Nullable)data;
/*!
...
/*!
 @abstract Deprecated Notifies the developer of the CLCircularRegions being monitored.
 @deprecated This method is deprecated, use NSNotification @link SMLocationManagerDidUpdateGeoLocations @/link
 ...
 */
- (void)sessionM:(SessionM*)sessionM didStartMonitoringRegions:(NSArray<__kindof CLRegion *> *)regions __attribute__((deprecated));
@end
 ...
 */
- (void)logAction:(NSString *)action withCount:(NSUInteger)count payloads:(NSDictionary<NSString *, NSObject *> * _Nullable)payloads;
/*!
 ...
 */
- (BOOL)signUpUserWithData:(NSDictionary<NSString *, NSObject *> *)userData;
/*!
 ...
 */
- (BOOL)handleRemoteNotification:(NSDictionary<NSString *, NSObject *> *)userInfo;
/*!
 ...
 */
- (instancetype)initWithAchievmentData:(SMAchievementData *)data __attribute__((deprecated));
- (instancetype)initWithAchievementData:(SMAchievementData *)data;
/*!
 ...
 */
extern NSString *const SMSessionMDidFailRequestNotification;
