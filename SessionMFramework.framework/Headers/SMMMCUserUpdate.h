 ...
 */
@property(nonatomic, assign, readwrite) CLLocationDegrees latitude; /* update current zip, state, country, etc */
/*!
 @property longitude
 ...
 */
@property(nullable, nonatomic, strong, readonly)  NSDictionary<NSString *, NSObject *> *dictionary;
