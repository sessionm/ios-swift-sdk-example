 ...
 */
typedef void (^uploadProgress)(SMReceipt * _Nullable receipt, SMError * _Nullable error);
/*!
 ...
 */
typedef void (^didUploadReceipt)(SMReceipt * _Nullable receipt, SMError * _Nullable error);
/*!
 ...
 */
typedef void (^didFetchReceipts)(NSArray<SMReceipt *> * _Nullable receipts, SMError * _Nullable error);
 ...
 */
- (NSString * _Nullable)uploadReceiptImages:(NSArray <NSString *> *)assetIDs withCampaignID:(NSString *)campaignID placementID:(NSString * _Nullable)placementID data:(NSDictionary * _Nullable)data __attribute__((deprecated("Use uploadReceiptImages:withCampaignID:placementID:data:completionHandler:progressHandler:")));
/*!
 @abstract Uploads the receipt images with the specified asset identifiers for the specified campaign.
 @param assetIDs Array of <code>PHObject</code> <code>localIdentifier</code> strings.
 @param campaignID ID of promotional campaign for which receipt is being uploaded.
 ...
 @result Returns upload group ID on success (returns nil otherwise).
 */
- (NSString * _Nullable)uploadReceiptImages:(NSArray <NSString *> *)assetIDs withCampaignID:(NSString *)campaignID placementID:(NSString * _Nullable)placementID data:(NSDictionary * _Nullable)data completionHandler:(didUploadReceipt)onCompletion progressHandler:(uploadProgress)onProgress;
/*!
 ...
 */
- (NSString * _Nullable)uploadReceiptImageFiles:(NSArray <NSString *> *)paths withCampaignID:(NSString *)campaignID placementID:(NSString * _Nullable)placementID data:(NSDictionary * _Nullable)data __attribute__((deprecated("Use uploadReceiptImageFiles:withCampaignID:placementID:data:completionHandler:progressHandler:")));
/*!
 @abstract Uploads the receipt images with the specified file paths for the specified campaign.
 @param paths Array of image file paths.
 @param campaignID ID of promotional campaign for which receipt is being uploaded.
 ...
 */
- (NSString * _Nullable)uploadReceiptImageFiles:(NSArray <NSString *> *)paths withCampaignID:(NSString *)campaignID placementID:(NSString * _Nullable)placementID data:(NSDictionary * _Nullable)data completionHandler:(didUploadReceipt)onCompletion progressHandler:(uploadProgress)onProgress;
/*!
 ...
 */
- (NSString * _Nullable)resumeIncompleteUploadForGroupID:(NSString *)groupID __attribute__((deprecated("Use resumeIncompleteUploadForGroupID:completionHandler:progressHandler:")));
/*!
 @abstract Resumes the incomplete receipt upload with the specified group ID.
 @param groupID ID of receipt upload that will be resumed.
 @param onCompletion The block to execute after all images are uploaded.
 ...
 @result Returns upload group ID on success (returns <code>nil</code> otherwise).
 */
- (NSString * _Nullable)resumeIncompleteUploadForGroupID:(NSString *)groupID completionHandler:(didUploadReceipt)onCompletion progressHandler:(uploadProgress)onProgress;
