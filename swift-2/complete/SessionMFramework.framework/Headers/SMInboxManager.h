 ...
 */
typedef void (^didFetchInboxMessages)(NSArray<SMInboxMessage *> * _Nullable messages, SMError * _Nullable error);
/*!
 ...
 */
typedef void (^didUpdateInboxMessages)(NSArray<SMInboxMessage *> * _Nullable messages, SMError * _Nullable error);
