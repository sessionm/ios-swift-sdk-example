 ...
 */
typedef void (^didFetchContents)(NSArray<SMContent *> * _Nullable messages, NSString * _Nullable placement, SMError * _Nullable error);
/*!
 ...
 */
typedef void (^didFetchSingleContent)(SMContent * _Nullable message, SMError * _Nullable error);
...
/*!
 ...
 @result <code>BOOL</code> indicating whether the request will be sent.
 */
- (BOOL)fetchContentsForPlacement:(NSString * _Nullable)placement limit:(NSInteger)limit page:(NSInteger)page completionHandler:(didFetchContents)onCompletion;
/*!
