 ...
 */
extern NSString *const SM_REFERRALS_MANAGER_NOTIFICATION_ERRORS_KEY;
 ...
 */
- (void)didSendReferrals:(NSArray<SMReferral *> * _Nullable)referrals referralErrors:(NSArray<SMReferralError *> * _Nullable)referralErrors error:(SMError * _Nullable)error __attribute__((deprecated("Use block methods instead")));
/*!
 ...
 */
typedef void (^didSendReferrals)(NSArray<SMReferral *>* _Nullable successfulReferrals, NSArray<SMReferralError *>* _Nullable referralErrors, SMError * _Nullable error);
/*!
 @typedef didFetchReferrals
 @abstract Completion handler block type for @link fetchReferralsWithCompletionHandler: @/link.
 */
typedef void (^didFetchReferrals)(NSArray<SMReferral *>* _Nullable referrals, SMError * _Nullable error);
/*!
 @typedef didFetchSingleReferral
 @abstract Completion handler block type for @link fetchReferralWithID:completionHandler: @/link.
 */
typedef void (^didFetchSingleReferral)(SMReferral * _Nullable referral, SMError * _Nullable error);
