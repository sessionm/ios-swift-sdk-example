...
/*!
 ...
 @deprecated Use method @link newInstanceWithActivityType: @/link instead.
 */
+ (SMActivityViewController * _Nullable)newInstance __attribute__((deprecated));
/*!
 ...
 @result <code>SMActivityViewController</code> object.
 */
+ (SMActivityViewController * _Nullable)newInstanceWithActivityType:(SMActivityType)type;
/*!
 ...
 @result <code>SMActivityViewController</code> object.
 */
+ (SMActivityViewController * _Nullable)newInstanceWithActivityType:(SMActivityType)type inNavigationController:(UINavigationController * _Nullable)navigationController;
/*!
 ...
 @result <code>SMActivityViewController</code> object.
 */
+ (SMActivityViewController * _Nullable)newInstanceWithActivityType:(SMActivityType)type inTabBarController:(UITabBarController *)tabBarController;
/*!
 ...
 @result <code>SMActivityViewController</code> object.
 */
+ (SMActivityViewController * _Nullable)newInstanceWithActivityType:(SMActivityType)type inNavigationController:(UINavigationController * _Nullable)navigationController inTabBarController:(UITabBarController* _Nullable)tabBarController;
 ...
 */
+ (void)setBlacklistAlertTitle:(NSString * _Nullable)title;
/*!
 ...
 */
+ (void)setBlacklistAlertMessage:(NSString * _Nullable)message;
/*!
 ...
 */
+ (void)setBlacklistAlertButtonTitle:(NSString * _Nullable)title;
