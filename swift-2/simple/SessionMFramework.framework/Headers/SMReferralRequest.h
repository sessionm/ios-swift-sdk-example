 ...
 */
- (instancetype)initWithEmail:(NSString *)email name:(NSString * _Nullable)name phoneNumber:(NSString * _Nullable)phoneNumber origin:(NSString * _Nullable)origin source:(NSString * _Nullable)source clientData:(id _Nullable)clientData;
/*!
 ...
 */
- (instancetype)initWithRequests:(NSArray<SMReferralRequest *> *)requests referrer:(NSString * _Nullable)referrer;
