 ...
 */
typedef void (^didFetchPlaces)(NSArray<SMPlace *>* _Nullable places, SMError * _Nullable error);
/*!
 @typedef didCheckIn
 @abstract Completion handler block type for @link checkInPlace:completionHandler: @/link.
 */
typedef void (^didCheckIn)(SMPlaceCheckinResult * _Nullable checkin, SMError * _Nullable error);
 ...
 */
- (BOOL)fetchPlacesAroundLocation:(CLLocation *)location withRadius:(float)radius limit:(int)limit adUnitID:(NSString * _Nullable)adUnitID __attribute__((deprecated("Use fetchPlacesAroundLocation:withRadius:limit:adUnitID:completionHandler:")));
/*!
 @abstract Makes a request to update @link places @/link with a limited number of venues available for check in inside the circle with the specified radius centered at the specified location.
 @param location The center of the circle in which places will be fetched.
 @param radius The radius in meters of the circle in which places will be fetched (optional).
 ...
 @result <code>BOOL</code> indicating whether the request will be sent.
 */
- (BOOL)fetchPlacesAroundLocation:(CLLocation *)location withRadius:(float)radius limit:(int)limit adUnitID:(NSString * _Nullable)adUnitID completionHandler:(didFetchPlaces)onCompletion;
/*!
