 ...
 */
typedef void (^didFetchMMCUser)(SMMMCUser * _Nullable user, SMError * _Nullable error);
/*!
 @typedef didUpdateMMCUser
 @abstract Completion handler block type for @link updateMMCUser:completionHandler: @/link.
 */
typedef void (^didUpdateMMCUser)(SMMMCUser * _Nullable user, SMError * _Nullable error);
/*!
 @typedef didXYZSMS
 ...
 */
typedef void (^verificationResponseSMS)(SMSVerification * _Nullable verification, SMError * _Nullable error);
...
/*!
 ...
 @result <code>BOOL</code> indicating whether the request will be sent.
 */
- (BOOL)sendSMSVerificationMessageToPhoneNumber:(NSString *)phoneNumber completionHandler:(verificationResponseSMS)onCompletion;
/*!
...
/*!
 ...
 @result <code>BOOL</code> indicating whether the request will be sent.
 */
- (BOOL)checkSMSVerificationCode:(NSString *)code completionHandler:(verificationResponseSMS)onCompletion;
/*!
...
/*!
 ...
 @result <code>BOOL</code> indicating whether the request will be sent.
 */
- (BOOL)fetchSMSVerificationWithCompletionHandler:(verificationResponseSMS)onCompletion;
