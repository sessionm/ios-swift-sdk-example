...
/*!
 ...
 @result Returns upload group ID on success (returns nil otherwise).
 */
- (NSString *)uploadReceiptImages:(NSArray <NSString *> *)assetIDs withCampaignID:(NSString *)campaignID placementID:(NSString * _Nullable)placementID data:(NSDictionary * _Nullable)data completionHandler:(didUploadReceipt)onCompletion progressHandler:(uploadProgress)onProgress;
/*!
 ...
 */
- (NSString *)uploadReceiptImageFiles:(NSArray <NSString *> *)paths withCampaignID:(NSString *)campaignID placementID:(NSString * _Nullable)placementID data:(NSDictionary * _Nullable)data completionHandler:(didUploadReceipt)onCompletion progressHandler:(uploadProgress)onProgress;
/*!
