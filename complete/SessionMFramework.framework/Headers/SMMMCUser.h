 ...
 */
@property(nullable, nonatomic, strong, readonly) NSString *zipCode; /* where customer home is registered */
/*!
 @property DMA
 ...
 */
@property(nullable, nonatomic, strong, readonly) NSString *currentZipCode;  /* Where they are currently at */
/*!
 @property currentDMA
