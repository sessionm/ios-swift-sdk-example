 ...
 */
typedef void (^didFetchLoyaltyCards)(NSArray<SMLoyaltyCard *> * _Nullable cards, SMError * _Nullable error);
/*!
 ...
 */
typedef void (^didFetchLoyaltyCardTransactions)(NSArray<SMLoyaltyCardTransaction *> * _Nullable transactions, SMError * _Nullable error);
/*!
 ...
 */
typedef void (^didLinkLoyaltyCard)(NSString * _Nullable cardNumber, SMError * _Nullable error);
/*!
 @typedef didUnlinkLoyaltyCard
 @abstract Completion handler block type for @link unlinkLoyaltyCardID:completionHandler: @/link.
 */
typedef void (^didUnlinkLoyaltyCard)(SMError * _Nullable error);
 ...
 */
typedef void (^didFetchRetailers)(NSArray<SMRetailer *> * _Nullable retailers, SMError * _Nullable error);
 ...
 */
- (BOOL)fetchRetailersWithZipCode:(NSString * _Nullable)zipCode __attribute__((deprecated("Use fetchRetailersWithZipCode:completionHandler:")));
/*!
 @abstract Makes a request to update @link retailers @/link with retailers in the specified zipcode for which a user can link a loyalty card.
 @param zipCode Zipcode in which to search for retailers (optional).
 @param onCompletion The block to execute after the request is processed.
 @result <code>BOOL</code> indicating whether the request will be sent.
 */
- (BOOL)fetchRetailersWithZipCode:(NSString * _Nullable)zipCode completionHandler:(didFetchRetailers)onCompletion;
