 ...
 */
typedef void (^didFetchFeedMessages)(NSArray<SMFeedMessage *>* _Nullable messages, SMError * _Nullable error);
 ...
 */
- (BOOL)fetchFeedMessagesWithLocale:(NSLocale * _Nullable)locale __attribute__((deprecated("Use fetchFeedMessagesWithLocale:completionHandler:")));
/*!
 ...
 @result <code>BOOL</code> indicating whether the request will be sent.
 */
- (BOOL)fetchFeedMessagesWithLocale:(NSLocale * _Nullable)locale completionHandler:(didFetchFeedMessages)onCompletion;
